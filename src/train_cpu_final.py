...
print("🚀 CPU-ONLY TRAINING (No OOM, no tokenizer issues)")

data = torch.load("rtx_dummy.pt")
print(f"Training on {len(data)} samples")

# Pre-stack ALL data (no DataLoader issues)
...
for epoch in tqdm(range(30)):
    ...
    # Manual mini-batches (batch_size=16)
...
print("Model saved: language_biased_vla_final.pt")
